...
<html lang="en">
    ...
    <body class="background">
        <header class="row fixed-top rounded-bottom header">
            <div class="col">
                <a href="" class="btn mt-1"> <i class="bi bi-house-door-fill headerIcons"></i> </a>
            </div>
            <div class="col">
                <h1 class="text-center mt-2 mb-2"> <i class="bi bi-flower1"></i> <u> Cara's Art Shop </u> <i class="bi bi-flower1"></i> </h1>
            </div>
            <div class="col">
                <a href="" class="btn mt-1 float-end"> <i class="bi bi-gear-fill headerIcons"></i> </a>
            </div>
                ...
                <form action="index.php" method="post" onsubmit="return validateOrder()">
                   <div class="row">
                    ...
                    <div class="btn-group d-flex">
                        ...
                        <a href="" class="btn btn-primary w-100 buttonIcons"> Cancel order <i class="bi bi-x-circle"></i></a>
                    </div>
                </form>
            </div>
        <?php
